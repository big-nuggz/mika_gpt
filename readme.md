...
Inside `./static_prompts/prompt_md`, you can edit the system prompt to change the behavior and personality of the AI. Only edit the `default_core_memory.md`, which contains default core memory every chat will be initialized with. This is where you put all the persona/personality of the AI.
